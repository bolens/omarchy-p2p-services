...
assert.equal((`${ci}\n${compatibility}`.match(/ghcr\.io\/bolens\/omarchy-plugin-ci@sha256:293b0457198085de5df26519dd4aa336202495c080d253b71ac30e7d8e8d3851/g) || []).length, 2)
assert.doesNotMatch(ci, /pacman -Syu/)
assert.doesNotMatch(compatibility, /pacman -Syu/)
