  ...
  function saveWidgetIcon(value) {
    ...
    page.controller.persistKeepingOpen({widgetIcon: icon || "󰒍"})
          ...
          P2PSettingsGrid {
            ...
            P2PThemeRoleSetting { Layout.columnSpan: themeRoleGrid.twoColumns ? 2 : 1; controller: page.controller; settingKey: "activityColorRole"; label: "Transfer activity color"; fallback: "accent" }
          }
          }
}
