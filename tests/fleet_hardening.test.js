...
const suiteChecker = read("scripts/check-plugin-suite")
...
assert.match(ci, /bolens\/.github\/.github\/workflows\/reusable-actionlint\.yml@d30ff6a56b47317d3d565e7b4747d133966db8d2/)
...
for (const label of ["bug", "enhancement", "documentation", "dependencies", "docker", "github-actions", "ci", "tests", "qml", "javascript", "backend", "shell", "site", "metadata", "release"])
...
assert.ok(fs.statSync("scripts/check-plugin-suite").mode & 0o100)
