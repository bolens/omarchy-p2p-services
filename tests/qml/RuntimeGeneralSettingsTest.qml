...
ShellRoot {
  ...
  Component.onCompleted: Qt.callLater(function() {
    ...
    if (!privacy || !stopped || !defaultView || !savedView || !behaviorGrid || !notificationGrid || !notificationValueGrid || !defaultGrid || !autoStart || !actionNotifications) throw new Error("general settings controls are not addressable")
